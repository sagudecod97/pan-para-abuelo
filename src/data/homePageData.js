...
const homePageData = {
  ...
  homeIntroduction: {
    ...
    description: [
      ...
      lugar un verdadero hogar.`, `Nos enorgullece nuestra autonomía administrativa y nuestro compromiso con la legalidad. Sometidos 
  ...
  homeHowToHelp: {
    ...
    description: [`Descubre cómo puedes marcar la diferencia. Desde apoyar a nuestros abuelos con compras en nuestro Ropero hasta donar para honrar 
    ...
    cardsData: [
      ...
      {
        title: 'Donaciones',
        description: [`¡Sería genial contar con tu ayuda! Puedes depositar tu aporte en nuestras cuentas de ahorros. Necesitamos alimentos, 
